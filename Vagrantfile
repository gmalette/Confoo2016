...
Vagrant.configure(2) do |config|
  ...
  config.vm.provision :shell, inline: <<-SHELL
    ...
    echo newrelic-php5 newrelic-php5/license-key string 324bec1441076c34c37333a0568f85039514de65 | debconf-set-selections
    sudo apt-get update
    sudo apt-get install -y newrelic-php5
    sudo apt-get install -y newrelic-sysmond
    nrsysmond-config --set license_key=324bec1441076c34c37333a0568f85039514de65
